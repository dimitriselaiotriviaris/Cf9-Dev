...
public class FileWritersJavaIo {
    ...
    public static void main(String[] args) {
        ...
        try (PrintStream ps = new PrintStream("D:/Coding Factory/Cf9Dev/src/gr/aueb/cf/cf9/ch9/file-ps.txt")) {
            fileWriter(file.getAbsolutePath());
            buffedWriter(file.getAbsolutePath());

            //Flexible usage of sayHello() method
            sayHello(System.out);
            sayHello(ps);
        }catch (IOException e){
            System.out.println("The the file has not been made");
        }
    }
    ...
    public static void buffedWriter(String file) throws IOException{
